        ...
        <div className=" flex flex-row sm:flex-col sm:pt-0 inner_left  justify-start gap-12 p-[100px] pb-0 pt-0 md:px-10 sm:px-5 w-full sm:w-full sm:-mt-[22rem]">
          <div className="flex w-[70%] sm:w-full md:flex-col -mt-[2rem] flex-row gap-[52px] items-start justify-start max-w-[1239px] mb-[52px] overflow-y-auto">
            <div className="flex md:flex-1 flex-col items-start justify-start md:mt-0 mt-[13px] w-full md:w-full">
              {/* <Img
                className="sm:hidden h-[488px]  rounded-xl  sm:h-auto object-cover w-full"
                src={infra}
                alt="rectangle22116"
              /> */}
              <Text
              ...
              <Text
                className="leading-[29.00px] mt-[18px] text-[18px] text-black-900 tracking-[0.50px]"
                size="txtLatoRegular15Black900cc"
              >
                <>
                 <span className="text-black-900 font-lato text-left text-xl font-bold"> Physical Security:</span>
                  <br />
                  <p className="mt-4 -mb-3">   <strong> Access Control Systems:</strong> Implementing measures like biometric access, key cards, or PIN codes to regulate entry.</p>
                  <br />
                <p className="-mb-3"> <strong> Perimeter Security:</strong> Fencing, barriers, and surveillance to secure the outer boundaries.</p>
                  <br />
                 <strong> Security Personnel: </strong>Trained guards strategically placed for observation and immediate response.
                </>
              </Text>
              <Text
                className="leading-[29.00px] mt-[20px] sm:mt-4 text-black-900 text-xl tracking-[0.50px]"
              ...
              >
                ...
                <span className="leading-[29.00px] mt-[18px] text-[18px] text-black-900 tracking-[0.50px]">
                  <>
                <p className="mt-4 -mb-3"> <strong> Surveillance Systems:</strong> High-definition cameras and monitoring tools for real-time observation.</p>
                    <br />
            
                    <p className=" -mb-3 pb-3"> <strong>	Intrusion Detection Systems: </strong>Sensors and alarms that trigger alerts in the event of unauthorized access.</p>
                  </>
                </span>
              </Text>
              <Text
