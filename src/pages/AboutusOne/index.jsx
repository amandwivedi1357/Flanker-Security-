          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1164px] mt-[95px] mx-auto md:px-5 w-full">
            ...
            <div  className="ml-[125px] flex flex-col items-start justify-start md:mt-0 mt-[125px]">
              ...
              <Text
                ...
                size="txtLatoRegular15Black900cc"
              >
                Flanker was established with a visionary approach of making
                Security Services Sector highly professional, tech oriented, and
                backed by Artificial Intelligence to provide unmatched security,
                safety and protection to individuals and enterprises.
              </Text>
            </div>
          </div>
          <Img className="h-2.5" src="images/img_contrast.svg" alt="contrast" />
          <div className="font-redhatdisplay h-[514px] md:h-[626px] sm:h-[773px] mt-[114px] md:px-5 relative w-full">
            <div
              className="bg-cover bg-no-repeat flex flex-col h-full items-center justify-start m-auto p-[102px] md:px-10 sm:px-5 w-full"
              style={{ backgroundImage: "url('images/img_group50520.svg')" }}
            >
              <div className="flex flex-col gap-[19px] items-center justify-start mb-[120px]">
                <Text
                ...
                <Text
                  className="capitalize leading-[50.00px] md:text-3xl sm:text-[28px] text-[32px] text-center text-gray-900 tracking-[1.00px] w-full"
            ...
            <div className="absolute bottom-[1%] flex sm:flex-col flex-row sm:gap-5 inset-x-[0] items-end justify-evenly mx-auto w-full">
              <Img
              ...
              <Img
                ...
                src="images/img_pngwing3_193x464.png"
                alt="pngwingThree"
              />
            </div>
          </div>
