      ...
      <form onSubmit={sendEmail} className="sm:ml-auto sm:mt-[5%] sm:w-[85%] absolute bg-white-A700 flex flex-col gap-[52px] h-max inset-y-[0] items-start justify-center my-auto p-[60px] md:px-10 sm:px-5 right-[7%] rounded w-[43%]">
        <div className=" flex flex-col items-center justify-start mt-[3px] w-full">
          <div className="flex flex-col items-start justify-start w-full">
            <a
              href="javascript:"
              className="text-gray-600 text-sm tracking-[2.00px] uppercase sm:mx-auto"
            >
              <Text size="txtRedHatDisplayRomanMedium14">contact us</Text>
            </a>
            <Text
              className="mt-[19px] text-4xl sm:mx-auto sm:text-[32px] md:text-[34px] text-gray-900_e5 tracking-[0.36px]"
            ...
            <div className=" font-lato sm:gap-5 gap-[26px] sm:mx-auto grid sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] mt-[37px] w-full">
        ...
        <div className="flex flex-col ml-1 items-center justify-start mb-[3px] w-[32%] md:w-full">
          <Button type="submit" className="sm:mr-12 border hover:bg-transparent  border-orange-400 border-solid capitalize cursor-pointer font-medium h-11 leading-[normal] min-w-[155px] text-base text-center tracking-[0.16px]">
            get in touch
          </Button>
        </div>
      </form>
